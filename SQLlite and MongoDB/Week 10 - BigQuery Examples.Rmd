...
This dataset contains the number of crimes at two different geographic levels of London (LSOA and borough) by year, according to crime type. 

Change your project name such that the `bigrquery` package knows that it has to request the public datasets now.
...
Update the dataset name and connect again:
